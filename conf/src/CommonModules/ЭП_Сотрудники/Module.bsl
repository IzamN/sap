...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "ЭП_Сотрудники";
	Описание.Версия = "1.0.1.0";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ЭП_Сотрудники.ОбновитьПредопределенныеВидыКонтактнойИнформацииСотрудников";
	Обработчик.РежимВыполнения = "Оперативно";
...
Процедура ОбновитьПредопределенныеВидыКонтактнойИнформацииСотрудников() Экспорт
	...
	//ГруппаКонтактнойИнформации.Имя = "СправочникЭП_Сотрудники";
	...
	ПараметрыВида.Вид = "ЭП_EmailСотрудника";
	...
	ПараметрыВида.Вид = "ЭП_ТелефонСотрудника";
	ПараметрыВида.МожноИзменятьСпособРедактирования = Истина;
	ПараметрыВида.РазрешитьВводНесколькихЗначений = Истина;
	...
	ПараметрыВида.Вид = "ЭП_АдресСотрудника";
	ПараметрыВида.МожноИзменятьСпособРедактирования = Истина;
...
Процедура ЭП_АктуализацияДействительностиПользователей() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	И ЭП_Сотрудники.СтатусСотрудника = &СтатусСотрудника";
...
Функция ОпределитьГрейд(Оклад) Экспорт
	...
	Запрос.УстановитьПараметр("Оклад", Оклад*1.15);
...
Процедура ЭП_АвтозаполнениеИспытательныхСроков() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	               ...
	               |	И ЭП_СотрудникиДостижения.ДатаПлан <= &ТекущийПериод
	...
	Пока Выборка.Следующий() Цикл
		...
		СтруктураОтбора.Вставить("ВидДостижения", ДостижениеИспытательныйСрок);
		НайденныеСтроки = ТекЭлемент.Достижения.НайтиСтроки(СтруктураОтбора); 
		Если НайденныеСтроки.Количество() > 0 Тогда
			
			Для каждого НайденнаяСтрока Из НайденныеСтроки Цикл
				
				НайденнаяСтрока.ДатаФакт = КонецМесяца(НайденнаяСтрока.ДатаПлан) + 2;
