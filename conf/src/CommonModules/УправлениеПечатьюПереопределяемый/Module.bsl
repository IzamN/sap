...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// ЗиганшинД 20230809 ЭДИТПРО
	СписокОбъектов.Добавить(Документы.ЭП_ВыплатыПремий);
	СписокОбъектов.Добавить(Документы.ЭП_РасчетПоказателей);
	// ЗиганшинД 20230809 ЭДИТПРО
	
	//СпиридоновА 20240427
	СписокОбъектов.Добавить(Документы.ЭП_АктПриемаПередачи);
	СписокОбъектов.Добавить(Документы.ЭП_СписаниеОприходованиеТовара);
	СписокОбъектов.Добавить(Документы.ЭП_ПоступлениеТовара);
	//СпиридоновА 20240427
