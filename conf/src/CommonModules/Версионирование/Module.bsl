...
Процедура ЗарегистрироватьИзмененияОбъекта(Объект) Экспорт
	...
	Если ИмяОбъекта = "ТехническиеПроекты" Тогда
		
		ЗарегистрироватьИзмененияТехническийПроект(КоллекцияИзмененныхОбъектов, Пользователи.ТекущийПользователь(), КомментарийЗаписи);
...
Процедура ЗарегистрироватьИзмененияТехническийПроект(КоллекцияИзмененныхОбъектов, ТекущийПользователь, Комментарии) Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ДатыИзмененияОбъектов.КонтролируемыйОбъект КАК КонтролируемыйОбъект,
	|	ДатыИзмененияОбъектов.ДатаИзменения КАК ДатаИзменения,
	|	ДатыИзмененияОбъектов.Пользователь КАК Пользователь,
	...
	|ГДЕ
	|	ВерсииОбъектов.Период ЕСТЬ NULL";
