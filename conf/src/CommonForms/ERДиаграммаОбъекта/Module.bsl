...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Скрипник Д.А. 20230720
	//Если ЗначениеЗаполнено(СсылкаНаОбъект) Тогда
	//	СформироватьДиаграмму();
	//КонецЕсли; 
	// _Скрипник Д.А. 20230720
...
Процедура ПриОткрытии(Отказ)
	...
	Если Не ЗначениеЗаполнено(ПоказыватьСвязи) Тогда
		ПоказыватьСвязи = "Все";
	КонецЕсли;
...
КонецПроцедуры // _Скрипник Д.А. 20230720
...
Процедура СформироватьДиаграмму()
	...
	НастройкиДиаграммы = Новый Структура("ТолькоСвязанныеСвойства, ПоказыватьСвязи", ТолькоСвязанныеСвойства, ПоказыватьСвязи); 
	ERДиаграммы.СформироватьERДиаграммуОбъекта(СсылкаНаОбъект, Диаграмма, НастройкиДиаграммы);
