...
Процедура УстановитьПараметрыПоПроекту()
	...
	Если ЗначениеЗаполнено(Проект) Тогда
		...
		КаталогИБДляЗагрузкиМетаданных            = Проект.КаталогИБДляЗагрузкиМетаданных;
		ИмяПользователяИБДляЗагрузкиМетаданных    = Проект.ИмяПользователяИБДляЗагрузкиМетаданных;
		ПарольПользователяИБДляЗагрузкиМетаданных = Проект.ПарольПользователяИБДляЗагрузкиМетаданных;
		
		КаталогХранилищаДляЗагрузкиМетаданных            = Проект.Ветка.Имя;
		ИмяПользователяХранилищаДляЗагрузкиМетаданных    = Проект.ИмяПользователяХранилищаДляЗагрузкиМетаданных;
		ПарольПользователяХранилищаДляЗагрузкиМетаданных = Проект.ПарольПользователяХранилищаДляЗагрузкиМетаданных;
		
		ВыгружатьСправкуПриЗагрузкеМетаданных            = Проект.ВыгружатьСправкуПриЗагрузкеМетаданных;
