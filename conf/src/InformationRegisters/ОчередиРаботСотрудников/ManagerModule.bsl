...
Функция ВариантПереносаПриИзмененииПриоритетаЗадачи(Исполнитель, Задача, НовыйПриоритет) Экспорт
	...
	Запрос.Текст = "
	|ВЫБРАТЬ
	|	ПриоритетыРабот.РеквизитДопУпорядочивания КАК РеквизитДопУпорядочивания
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПриоритетыРаботСправочник.РеквизитДопУпорядочивания КАК РеквизитДопУпорядочивания
	...
	|ВЫБРАТЬ
	|	ВЫБОР
	|		КОГДА НовыйПриоритет.РеквизитДопУпорядочивания > СтарыйПриоритет.РеквизитДопУпорядочивания
