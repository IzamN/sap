...
#Если Не ВебКлиент Тогда
	...
	ФайловаяСистемаКлиент.ОткрытьФайл(ИмяФайла,
		Новый ОписаниеОповещения("ОткрытьСообщениеЗавершение",
		ЭтотОбъект,
...
&НаКлиенте
Процедура ОткрытьСообщениеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	
	НачатьУдалениеФайлов(Новый ОписаниеОповещения, ДополнительныеПараметры.ИмяФайла)
