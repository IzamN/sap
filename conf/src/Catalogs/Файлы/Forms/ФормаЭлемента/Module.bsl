...
Процедура ЭП_ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппаЭлементов = Элементы.Найти("ГруппаСведенияЧасть1");
	ЭлементПривязки = Элементы.Найти("ХранитьВерсии");
	НовыйЭлемент = Элементы.Вставить("ЭП_ВидФайла", Тип("ПолеФормы"), ГруппаЭлементов, ЭлементПривязки);
	НовыйЭлемент.ПутьКДанным = "Объект.ЭП_ВидФайла";
