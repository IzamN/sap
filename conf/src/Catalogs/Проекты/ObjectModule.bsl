...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если (ЭП_Архивный = Перечисления.ЭП_СтатусПроекта.Архивный ИЛИ ЭП_Архивный = Перечисления.ЭП_СтатусПроекта.АрхивныйСПросмотром) И Не ЗначениеЗаполнено(ЭП_ДатаОтправкиВАрхив) Тогда
		
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Запись не возможна. Не установлена дата отправки в архив для архивного проекта.",,,,Отказ);	
