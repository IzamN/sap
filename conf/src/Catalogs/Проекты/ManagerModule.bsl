...
Процедура ЗарегистрироватьДанныеКОбработкеЗаполненияНаборовСвойств(Параметры) Экспорт
...
Процедура ОбработатьДанныеДляЗаполненияНаборовСвойств(Параметры) Экспорт
	...
	ПолноеИмяОбъекта = "Справочник.Проекты";
	...
	|	Справочник.Проекты КАК Проекты
	|ГДЕ
	|	Проекты.Ссылка В(&СписокОбъектов)"
	;
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru = 'Не удалось заполнить группы наборов свойств для объекта %ИмяОбъекта%: %Ссылка% по причине: %Причина%'");
...
Процедура ОбработатьДанныеДляЗаполненияНаборовСвойств_206(Параметры) Экспорт

	ОбработатьДанныеДляЗаполненияНаборовСвойств(Параметры);
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Параметры.Отбор.Вставить("ЭП_Архивный", Перечисления.ЭП_СтатусПроекта.Действующий);
