...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПоказатьАрхивные", Ложь);
	ПаказатьАрхивные = Ложь;
...
Процедура ПоказатьАрхивныеНаСервере(Архивные)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПоказатьАрхивные", Архивные);
...
Процедура ПоказатьАрхивные(Команда)
	...
	Если НЕ ПоказатьАрхивные Тогда
		...
		Элементы.ФормаПоказатьАрхивныеЭтапы.Заголовок = "Показать не архивированные";
		
	Иначе
		
		ПоказатьАрхивные = Ложь;
		ПоказатьАрхивныеНаСервере(ПоказатьАрхивные);
	    Элементы.ФормаПоказатьАрхивныеЭтапы.Заголовок = "Показать архивные";
		
	КонецЕсли;
	Элементы.ФормаПоказатьАрхивныеЭтапы.Пометка = ПоказатьАрхивные;
