...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Отбор.Свойство("Проект") Тогда
		Проект = Отбор.Проект;
	// ЗиганшинД 14.07.23 Добавлен отбор по Владельцу в Документе ЭП_КорректировкаПремий 
	ИначеЕсли Отбор.Свойство("Владелец") Тогда
		Проект = Отбор.Владелец;	
	// ЗиганшинД 14.08.23 и ЭП_ВыплатаПремий, в самой форме документа нужно выбрать Отбор по проекту в реквизите Этап свойства СвязиПараметровВыбора		
	Иначе
