...
Процедура СформироватьЗаголовокФормы(Форма)
	...
	Если Объект.ТипПлана = ПредопределенноеЗначение("Перечисление.ТипыПланов.Занятости") Тогда
		...
		Если Объект.Ссылка.Пустая() Тогда
			...
			Форма.Заголовок = НСтр("ru = 'План занятости (создание)'");
			
		Иначе
			
			Форма.Заголовок = СтрШаблон(НСтр("ru = '%1 (План занятости)'"), Объект.Наименование);
	...
	ИначеЕсли Объект.ТипПлана = ПредопределенноеЗначение("Перечисление.ТипыПланов.Рабочий") Тогда
		...
		Если Объект.Ссылка.Пустая() Тогда
			...
			Форма.Заголовок = НСтр("ru = 'Рабочий план (создание)'");
			
		Иначе
			
			Форма.Заголовок = СтрШаблон(НСтр("ru = '%1 (Рабочий план)'"), Объект.Наименование);
